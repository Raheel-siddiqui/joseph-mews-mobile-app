...
export const opportunities: Opportunity[] = [
  ...
  {
    id: "OPP-221",
    reference: "JM-OPP-221",
    name: "The Edition · Phase II",
    developer: "Princes Dock Group",
    city: "Liverpool",
    region: "North West",
    postcode: "L3 1DL",
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/113764710/ETLftU46Rt6EamfGSt3aTE/property-liverpool-waterfront-FSwzvtfydh5B8YcpPdF5Wr.webp",
    tagline: "The next release of Liverpool's most successful waterfront scheme to date.",
    status: "Coming Soon",
    unitTypes: [
      { type: "1-bed", fromPrice: 215000, sqftFrom: 520, available: 0, total: 32 },
      { type: "2-bed", fromPrice: 295000, sqftFrom: 720, available: 0, total: 22 },
    ],
    fromPrice: 215000,
    grossYield: 6.7,
    netYield: 5.0,
    capitalGrowth5Y: 21.0,
    ...
    highlights: [
      ...
      "Priority allocation for existing Joseph Mews investors",
    ],
    projection: [
      { year: 0, value: 215000 },
      { year: 1, value: 224000 },
  ...
  {
    id: "OPP-152",
    reference: "JM-OPP-152",
    name: "Northbank Quarter",
    developer: "Oakridge Developments",
    city: "Leeds",
    region: "Yorkshire",
    postcode: "LS1 4LT",
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/113764710/ETLftU46Rt6EamfGSt3aTE/property-manchester-modern-68N8NjiUtsxN7NXMHZzona.webp",
    tagline: "A mixed-use riverside masterplan in Leeds' South Bank regeneration zone.",
    status: "Sold Out",
    unitTypes: [
      { type: "1-bed", fromPrice: 218000, sqftFrom: 520, available: 0, total: 48 },
      { type: "2-bed", fromPrice: 295000, sqftFrom: 740, available: 0, total: 36 },
    ],
    fromPrice: 218000,
    grossYield: 6.8,
    netYield: 5.1,
    capitalGrowth5Y: 23.0,
    ...
    highlights: [
      ...
      "Resale enquiries via your advisor",
    ],
    projection: [
      { year: 0, value: 218000 },
      { year: 1, value: 228000 },
